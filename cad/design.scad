// Swarm Robotics - Basic Coordination — parametric demo chassis/base
$fn=48;
...
translate([0,0,T/2]) linear_extrude(0.8) text("mostafa-09-swarm-robotics", size=6, halign="center");
