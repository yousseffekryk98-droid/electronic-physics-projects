...
**Physics / engineering concepts:** IMU fusion, PID control, feedback stability

## Goal
Build a demonstrable educational prototype of **Self-Balancing Robot** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- MPU6050
- TB6612FNG motor driver
- 2 encoder gear motors
- wheels
- rigid chassis
- battery
- switch
...
|---|---|---|
| MPU6050 SDA/SCL | I2C | A4/A5 |
| Motor driver AIN1/AIN2>D7/D8 | — | — |
| BIN1/BIN2>D9/D10 | — | — |
| PWMA/PWMB | PWM | D5/D6 |
| Encoders | interrupt pins | D2/D3 |
