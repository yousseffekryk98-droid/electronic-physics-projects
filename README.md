...
**Physics / engineering concepts:** accelerometer/gyro magnitude, fall-event heuristics, emergency alert

## Goal
Build a demonstrable educational prototype of **Fall Detection System for Elderly** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| MPU6050 SDA/SCL | I2C | GPIO21/22 |
| Cancel button>GPIO27 INPUT_PULLUP | — | — |
| Buzzer>GPIO25 | — | — |
