...
**Physics / engineering concepts:** reflectance sensing, error calculation, PID line control

## Goal
Build a demonstrable educational prototype of **Autonomous Line Following Robot** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- 3-5 TCRT5000 line sensors/array
...
|---|---|---|
| Line sensors L/C/R | analog or digital | A0/A1/A2 |
| Motor driver IN1-IN4>D5-D8 | — | — |
| PWM enables>D9/D10 | — | — |
