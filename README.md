...
**Primary platform:** Arduino Nano  
**Physics / engineering concepts:** distance sensing, haptic feedback, assistive design

## Goal
Build a demonstrable educational prototype of **Smart Glasses for the Visually Impaired** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Nano
- HC-SR04 or VL53L0X distance sensor
- coin vibration motor
- NPN transistor or MOSFET
- flyback diode if inductive
- piezo buzzer
- Li-ion battery with protected regulator
- switch
...
|---|---|---|
| HC-SR04 TRIG | digital out | D9 |
| HC-SR04 ECHO | digital in | D10 |
| Vibration driver gate/base | PWM | D5 |
| Buzzer + | digital out | D6 |
| Sensor VCC | 5V | 5V |
| grounds | GND | GND |
