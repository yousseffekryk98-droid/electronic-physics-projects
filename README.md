...
**Primary platform:** Arduino Uno R4 WiFi or ESP32  
**Physics / engineering concepts:** multi-sensor intrusion detection, network alerts

## Goal
Build a demonstrable educational prototype of **Home Security System with Alerts** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- buzzer
- status LED
- optional email/webhook service
...
|---|---|---|
| PIR OUT | digital in | D2/ESP32 GPIO27 |
| Door reed | digital in | D3/GPIO26 with pull-up |
| Buzzer | digital out | D8/GPIO25 |
| LED | digital out | D9/GPIO2 |
