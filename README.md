# Bike Charging Station from Solar Cells with QR Code and Cloud using ESP32

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32  
**Physics / engineering concepts:** photovoltaics, MPPT, battery management, QR session control, telemetry

## Goal
Build a demonstrable educational prototype of **Bike Charging Station from Solar Cells with QR Code and Cloud using ESP32** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- ~200W prototype PV panel
- MPPT controller
- optional LiFePO4 battery + BMS
- USB-C PD/DC output modules
...
|---|---|---|
| INA219 SDA/SCL | I2C | GPIO21/22 |
| Port enable driver>GPIO26 | — | — |
| Display | I2C/SPI | board |
| PV | MPPT | battery/DC bus |
| fused DC bus>USB-C PD/output module | — | — |
| all low-voltage grounds>common as required | — | — |
