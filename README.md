# Mood-Based Room Lighting System

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32  
**Physics / engineering concepts:** sound reactivity, presets, FFT/envelope mapping, lighting control

## Goal
Build a demonstrable educational prototype of **Mood-Based Room Lighting System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| LED DIN>GPIO18 via 330R/level shifter | — | — |
| MAX4466 OUT | ADC | GPIO34 |
| Touch buttons>GPIO27/32/33 | — | — |
| LED 5V>external PSU | — | — |
| grounds | common | GND |
