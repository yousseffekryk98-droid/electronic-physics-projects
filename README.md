# Obstacle Avoiding Robot with Ultrasonic

**Instructor:** Dr/Mostafa Elhoshy  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** distance measurement, scanning, autonomous obstacle avoidance

## Goal
Build a demonstrable educational prototype of **Obstacle Avoiding Robot with Ultrasonic** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| HC-SR04 TRIG | D9 | Arduino |
| HC-SR04 ECHO | D10 | Arduino |
| Servo signal | D3 | Arduino |
| Motor driver IN1/IN2>D5/D6 | — | — |
| IN3/IN4>D7/D8 | — | — |
| ENA/ENB | PWM | D11/D12 or jumpers |
