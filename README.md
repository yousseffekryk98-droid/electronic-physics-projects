# Smart Medication Dispenser for Elderly

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32  
**Physics / engineering concepts:** scheduling, dispensing, load verification, missed-dose notification

## Goal
Build a demonstrable educational prototype of **Smart Medication Dispenser for Elderly** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- DS3231 RTC
- 2-4 servo motors or stepper
- HX711 + small load cell
- buzzer
- OLED
- buttons
- enclosure
...
|---|---|---|
| RTC SDA/SCL | I2C | GPIO21/22 |
| OLED SDA/SCL | I2C | GPIO21/22 |
| Servo(s) | PWM | GPIO25/26/27 |
| HX711 DT | SDA-like data | GPIO32 |
| HX711 SCK | clock | GPIO33 |
| Buzzer>GPIO13 | — | — |
