...
**Physics / engineering concepts:** distance sensing, occupancy threshold, cloud status

## Goal
Build a demonstrable educational prototype of **Smart Parking Space Detector** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- HC-SR04 or waterproof ultrasonic sensor
- red LED
- green LED
- 220R resistors
- 5V supply
...
|---|---|---|
| TRIG | digital out | GPIO5 |
| ECHO | digital in | GPIO18 through divider if 5V |
| Green LED>GPIO25 via 220R | — | — |
| Red LED>GPIO26 via 220R | — | — |
