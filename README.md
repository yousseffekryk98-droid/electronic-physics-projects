# Intelligent Traffic Density Analyzer

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Raspberry Pi + OpenCV  
**Physics / engineering concepts:** computer vision, vehicle counting, adaptive signaling

## Goal
Build a demonstrable educational prototype of **Intelligent Traffic Density Analyzer** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- microSD
- 5V PSU
- optional red/yellow/green LEDs with 330R resistors
...
|---|---|---|
| Camera | CSI/USB | Pi camera port or USB |
| Red LED | GPIO17 | 330R to GND |
| Yellow LED | GPIO27 | 330R to GND |
| Green LED | GPIO22 | 330R to GND |
