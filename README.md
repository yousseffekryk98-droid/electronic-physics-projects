...
**Physics / engineering concepts:** light sensing, differential control, solar tracking

## Goal
Build a demonstrable educational prototype of **Solar Tracking System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- 4 LDRs
- 4x10k resistors
- 2 servos or geared pan-tilt
- small solar panel
- frame
...
|---|---|---|
| LDR TL/TR/BL/BR | analog | A0/A1/A2/A3 via dividers |
| Pan servo | PWM | D9 |
| Tilt servo | PWM | D10 |
| panel | mechanical mount | pan-tilt |
