...
**Physics / engineering concepts:** Wi-Fi control, authorization, remote access, manual override

## Goal
Build a demonstrable educational prototype of **Smart Door Lock with Mobile App** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- high-torque servo or small demo latch
- push button
- red/green LEDs
- buzzer optional
- regulated supply
- mechanical override for demo
...
|---|---|---|
| Servo signal>GPIO26 | — | — |
| Button>GPIO27 INPUT_PULLUP | — | — |
| Green LED>GPIO32 | — | — |
| Red LED>GPIO33 | — | — |
| servo power | separate regulated 5V | common GND |
