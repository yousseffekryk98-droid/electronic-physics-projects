# Car Sharing Simulation — Mobile App + Cloud + ESP32 Lock

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32 + mobile/web app  
**Physics / engineering concepts:** client-server booking, secure device messaging, actuator fail-safe

## Goal
Build a demonstrable educational prototype of **Car Sharing Simulation — Mobile App + Cloud + ESP32 Lock** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- 5/12V solenoid/electric strike
- MOSFET driver + flyback diode
- reed/hall door sensor
- regulated PSU
...
|---|---|---|
| Solenoid + | supply + | 5/12V |
| Solenoid - | MOSFET drain | driver |
| MOSFET gate | digital out | GPIO26 |
| Flyback diode | across solenoid | reverse-biased |
| Door sensor | digital in | GPIO27 pull-up |
| Key switch | digital in | GPIO25 |
| GPS TX/RX | UART | GPIO16/17 |
...
- [Arduino core for ESP32](https://github.com/espressif/arduino-esp32) — Open-source ESP32 Arduino framework
