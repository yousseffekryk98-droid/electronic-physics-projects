# Simple Traffic Density Monitor

**Instructor:** Dr/Mostafa Elhoshy  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** vehicle counting, time-of-flight speed estimate, traffic classification

## Goal
Build a demonstrable educational prototype of **Simple Traffic Density Monitor** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| IR sensor 1 | interrupt | D2 |
| IR sensor 2 | interrupt | D3 |
| RGB R/G/B>D9/D10/D11 via resistors | — | — |
