...
**Physics / engineering concepts:** light sensing, adjustable threshold, hysteresis

## Goal
Build a demonstrable educational prototype of **Automatic Room Light Controller** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- 10k resistor
- 10k potentiometer
- 5V relay module or MOSFET
- low-voltage LED strip/lamp
...
|---|---|---|
| LDR divider | analog | A0 |
| Pot wiper | analog | A1 |
| Relay/MOSFET control | digital | D7 |
| low-voltage lamp | driver output | separate supply |
