# Water Level Management and Leakage Detection

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** fluid level, flow rate, leak inference, alerts

## Goal
Build a demonstrable educational prototype of **Water Level Management and Leakage Detection** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
| Flow pulse | interrupt | D2 |
| Leak DO | digital in | D4 |
