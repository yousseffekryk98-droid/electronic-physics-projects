...
**Physics / engineering concepts:** soil moisture measurement, automatic watering, hysteresis

## Goal
Build a demonstrable educational prototype of **Smart Irrigation System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| Moisture AO | analog | A0 |
| Pump driver | digital | D7 |
| Override button | digital in | D2 with INPUT_PULLUP |
| LCD SDA/SCL | I2C | A4/A5 |
| pump | external supply | driver |
