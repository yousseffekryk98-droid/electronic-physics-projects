# Cough/Sneeze Counter for Infection Tracking

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32  
**Physics / engineering concepts:** audio envelope/features, event counting, pattern classification

## Goal
Build a demonstrable educational prototype of **Cough/Sneeze Counter for Infection Tracking** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
