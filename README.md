...
**Physics / engineering concepts:** voice commands, serial control, servo kinematics

## Goal
Build a demonstrable educational prototype of **Voice Controlled Robotic Arm** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- 4x servo motors
- HC-05 Bluetooth or voice recognition module
- separate 5V servo PSU
- arm links
- gripper
- emergency stop
