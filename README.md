# Smart Air Quality and Pollution Index Monitor

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** ESP32  
**Physics / engineering concepts:** gas sensing, calibration, AQI-style index, IoT logging

## Goal
Build a demonstrable educational prototype of **Smart Air Quality and Pollution Index Monitor** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- 0.96in I2C OLED
- buzzer
- 10k/20k divider for 5V analog outputs
- breadboard
- regulated 5V supply
...
|---|---|---|
| MQ135 AO | ADC | GPIO34 via divider |
| MQ7 AO | ADC | GPIO35 via divider |
| OLED SDA | I2C SDA | GPIO21 |
| OLED SCL | I2C SCL | GPIO22 |
| Buzzer + | digital out | GPIO25 |
| all grounds | GND | GND |
...
- [ThingSpeak Arduino](https://github.com/mathworks/thingspeak-arduino) — Open-source telemetry client option
