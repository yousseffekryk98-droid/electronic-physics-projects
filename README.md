# Classroom Environment Optimization System

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** smart buildings, comfort optimization, feedback control

## Goal
Build a demonstrable educational prototype of **Classroom Environment Optimization System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| CO2 TX/RX | serial | D10/D11 |
| LDR divider | analog | A0 |
| DHT22 DATA | digital | D3 |
