...
**Physics / engineering concepts:** PIR motion detection, alarm state machine

## Goal
Build a demonstrable educational prototype of **Motion-Activated Alarm** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
