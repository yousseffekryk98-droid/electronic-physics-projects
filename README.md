...
**Physics / engineering concepts:** temperature sensing, threshold/hysteresis cooling

## Goal
Build a demonstrable educational prototype of **Temperature-Controlled Fan** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| DHT DATA>D3 | — | — |
| Fan driver gate/input>D6 | — | — |
| Fan | external supply | driver |
| Pot wiper>A0 optional | — | — |
| grounds | common | GND |
