# Brain-Controlled LED or Wheelchair (EEG-Based Control)

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno + EEG headset  
**Physics / engineering concepts:** biosignal acquisition, threshold classification, assistive control

## Goal
Build a demonstrable educational prototype of **Brain-Controlled LED or Wheelchair (EEG-Based Control)** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- MindWave-compatible EEG headset
- Bluetooth serial module if required
- LED + 220R resistor
- optional motor driver and small demo motors
- separate motor supply
- emergency-stop switch for mobility demo
...
|---|---|---|
| EEG TX | Arduino RX | D2 through SoftwareSerial/appropriate level |
| EEG GND | GND | GND |
| LED anode | digital out | D9 via 220R |
| Motor driver IN1 | digital out | D5 |
| Motor driver IN2 | digital out | D6 |
| E-stop | motor enable line | series hardware cutoff |
