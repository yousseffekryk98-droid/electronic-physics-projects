...
**Physics / engineering concepts:** closed-loop control, environmental sensing, agriculture technology

## Goal
Build a demonstrable educational prototype of **Smart Greenhouse Environment Control** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- DHT22
- MH-Z19B or equivalent CO2 sensor
...
|---|---|---|
| DHT22 DATA | digital in | D3 |
| CO2 TX/RX | serial | D10/D11 SoftwareSerial |
| Soil AO | analog | A0 |
| Fan driver | digital | D6 |
| Pump driver | digital | D7 |
