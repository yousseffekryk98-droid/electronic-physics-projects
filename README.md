...
**Primary platform:** Arduino Uno for logging  
**Physics / engineering concepts:** electromagnetic induction, resonant coupling, efficiency

## Goal
Build a demonstrable educational prototype of **Wireless Power Transfer Demonstration** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Low-voltage function generator or oscillator module
- transmitter coil
- receiver coil
- resonant capacitors
- rectifier diodes
...
|---|---|---|
| TX coil | oscillator | low-voltage driver |
| RX coil | rectifier/filter | load |
| INA219 | load path | I2C A4/A5 |
| Arduino | USB | logging PC |
