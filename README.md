...
**Physics / engineering concepts:** light sensing, occupancy control, energy saving

## Goal
Build a demonstrable educational prototype of **Energy-Efficient Smart Street Lighting** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
| PIR OUT | digital | D2 |
| MOSFET gate | PWM | D9 |
| LED lamp | 12V via MOSFET | battery |
