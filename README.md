# Multi-Sensor Fire Alarm System with Emergency Protocol

**Instructor:** Dr/Mostafa Elhoshy  
**Primary platform:** ESP32 or Uno R4 WiFi  
**Physics / engineering concepts:** sensor fusion, escalating alarms, false-alarm reduction

## Goal
Build a demonstrable educational prototype of **Multi-Sensor Fire Alarm System with Emergency Protocol** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| MQ-2 AO | ADC | GPIO34 via divider if required |
| DHT22 DATA>GPIO4 | — | — |
| Flame DO>GPIO27 | — | — |
| Buzzer>GPIO25 | — | — |
| Strobe>GPIO26 | — | — |
