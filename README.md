...
**Physics / engineering concepts:** temperature monitoring, RFID inventory, door-state alerts

## Goal
Build a demonstrable educational prototype of **Smart Refrigerator System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| DS18B20 DATA | 1-Wire | GPIO4 with 4.7k pull-up |
| RC522 SDA/SS | SPI SS | GPIO5 |
| RC522 SCK | SPI SCK | GPIO18 |
| RC522 MOSI | SPI MOSI | GPIO23 |
| RC522 MISO | SPI MISO | GPIO19 |
| RC522 RST | RST | GPIO27 |
| Reed switch | digital in | GPIO32 with pull-up |
