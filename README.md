# Swarm Robotics - Basic Coordination

**Instructor:** Dr/Mostafa Elhoshy  
**Primary platform:** Arduino Uno x2  
**Physics / engineering concepts:** multi-agent coordination, IR communication, formation following

## Goal
Build a demonstrable educational prototype of **Swarm Robotics - Basic Coordination** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- 2x Arduino Uno
- 2 robot chassis kits
...
|---|---|---|
| IR TX | digital out | D3 each robot |
| IR RX | digital in | D2 each robot |
| Motor driver inputs | D5-D8 | each Arduino |
| grounds | common per robot | local supply |
