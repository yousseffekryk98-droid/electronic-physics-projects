# Phone Charger Station from Solar Cells with QR Code and Cloud using ESP32

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32  
**Physics / engineering concepts:** solar sizing, USB charging, session logging, IoT dashboard

## Goal
Build a demonstrable educational prototype of **Phone Charger Station from Solar Cells with QR Code and Cloud using ESP32** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32
- 50-150W PV panel
- MPPT/PWM charge controller
- optional 7-12Ah LiFePO4 battery+BMS
- USB PD multi-port module
- INA219
- buck converter
- fuses
- display
...
| Port enable>GPIO26 | — | — |
| PV | charge controller | battery/DC bus |
| DC bus | fuse | buck/USB PD |
| display | I2C | GPIO21/22 |
