# Medical Oxygen Level Monitoring with Alert System

**Instructor:** Dr/Mostafa Elhoshy  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** PPG, heart-rate/SpO2 estimation, data logging

## Goal
Build a demonstrable educational prototype of **Medical Oxygen Level Monitoring with Alert System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
