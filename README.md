# Mini Weather Satellite (CubeSat Prototype)

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno/Nano  
**Physics / engineering concepts:** atmospheric sensing, data logging, satellite simulation

## Goal
Build a demonstrable educational prototype of **Mini Weather Satellite (CubeSat Prototype)** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| BMP SDA/SCL | I2C | A4/A5 |
| DHT DATA | digital | D3 |
| SD CS | SPI CS | D10 |
| SD MOSI/MISO/SCK | SPI | D11/D12/D13 |
