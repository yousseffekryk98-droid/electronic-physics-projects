# EM Field Detector and Analyzer

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno  
**Physics / engineering concepts:** electromagnetism, induction, analog amplification, signal analysis

## Goal
Build a demonstrable educational prototype of **EM Field Detector and Analyzer** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- inductive pickup coil
- low-noise op-amp such as LM358 for demo
- protection diodes
- RC filter
- OLED
...
|---|---|---|
| Pickup coil | op-amp input | conditioned analog signal |
| Op-amp output | ADC | A0 |
| OLED SDA/SCL | I2C | A4/A5 |
| clamp diodes | ADC rail protection | 5V/GND |
