...
**Physics / engineering concepts:** amplitude/time comparison, direction estimation, robotics

## Goal
Build a demonstrable educational prototype of **Sound Localization Robot** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- Arduino Uno
- 2 electret microphone amplifier modules
- SG90 servo
- optional 2-wheel chassis and motor driver
- 5V supply
...
| Mic R AO | analog | A1 |
| Servo signal | PWM | D9 |
| optional motor driver IN1/IN2 | D5/D6 | Arduino |
