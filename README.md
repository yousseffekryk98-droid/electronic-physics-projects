# IoT-Based Package Theft Detection System

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** ESP32-CAM  
**Physics / engineering concepts:** motion detection, evidence capture, remote notification

## Goal
Build a demonstrable educational prototype of **IoT-Based Package Theft Detection System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
|---|---|---|
| PIR OUT | digital in | GPIO13 |
| SIM800L TX | RX | GPIO16 via suitable serial |
| SIM800L RX | TX | GPIO17 with level compatibility |
| Camera | on-board | ESP32-CAM |
| grounds | GND | common |
