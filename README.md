# Smart Water Tap with Proximity Sensor

**Instructor:** Dr/Ahmed Ayoub  
**Primary platform:** ESP32 or Arduino  
**Physics / engineering concepts:** proximity sensing, debounce/hysteresis, fluid control, flow logging

## Goal
Build a demonstrable educational prototype of **Smart Water Tap with Proximity Sensor** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.

## Components / BOM
- ESP32/Arduino
- IR/ToF proximity sensor
- 12V water-rated normally-closed solenoid valve
...
|---|---|---|
| Proximity OUT | digital/ADC | GPIO27 |
| MOSFET gate | digital out | GPIO26 |
| Solenoid | 12V through MOSFET | driver |
| Flyback diode | across valve | reverse-biased |
| Flow pulse | interrupt | GPIO25 |
| grounds | common low-voltage ground | GND |
