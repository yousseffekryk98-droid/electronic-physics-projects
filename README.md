...
**Physics / engineering concepts:** RFID authentication, timestamps, web logging

## Goal
Build a demonstrable educational prototype of **Smart Attendance System with RFID** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- 220R resistors
- Wi-Fi
- Google Apps Script/other HTTPS endpoint
