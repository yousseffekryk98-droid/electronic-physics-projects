# Solar Power Monitoring and Optimization System

**Instructor:** Dr/Amir Elmslmany  
**Primary platform:** Arduino Uno + optional ESP32  
**Physics / engineering concepts:** renewable energy, IV power measurement, efficiency, telemetry

## Goal
Build a demonstrable educational prototype of **Solar Power Monitoring and Optimization System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
| LCD SDA | SDA | A4 |
| LCD SCL | SCL | A5 |
| Solar + | VIN+ | INA219 VIN+ |
| INA219 VIN- | Load + | load |
| Solar - | GND | common GND |
