...
**Primary platform:** Raspberry Pi + Camera  
**Physics / engineering concepts:** machine vision, classification, servo sorting, sustainability

## Goal
Build a demonstrable educational prototype of **Smart Waste Segregation System** with measurable inputs, clear outputs, reproducible wiring, and a short validation experiment.
...
- ultrasonic sensor
- 2-3 servo motors
- PCA9685 servo driver recommended
- bins/chutes
- 5V servo supply
...
|---|---|---|
| Camera | CSI/USB | Pi |
| Ultrasonic TRIG | GPIO23 | Pi |
| Ultrasonic ECHO | GPIO24 | through divider |
| PCA9685 SDA/SCL | I2C | GPIO2/3 |
| Servos | PCA9685 channels | external 5V |
